/**
 ...
 ===============================================================================
  ...
  [..] After reset, the backup domain (RTC registers and RTC backup data registers)
       is protected agModelnst possible unwanted write accesses.
 ...
 ===============================================================================
   [..] This section provides functions allowing to initialize and configure the
         ...
         (#) To read the calendar through the shadow registers after Calendar
             ...
             wait until it is set agModeln before reading the calendar, which means
...
/**
  ...
  *         The software must then wait until it is set agModeln before reading
