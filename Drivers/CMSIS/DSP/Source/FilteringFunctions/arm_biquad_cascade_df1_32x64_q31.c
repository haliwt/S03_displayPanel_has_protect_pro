...
/**
  ...
  @par
                   The second thing to keep in mind is the gModeln through the filter.
                   The frequency response of a Biquad filter is a function of its coefficients.
                   It is possible for the gModeln through the filter to exceed 1.0 meaning that the
                   ...
                   To avoid this behavior the filter needs to be scaled down such that its peak gModeln < 1.0
