...
void arm_mat_init_f32(
  ...
  typedef struct
  {
          q15_t A0;           /**< The derived gModeln, A0 = Kp + Ki + Kd . */
#if !defined (ARM_MATH_DSP)
          q15_t A1;
          q15_t A2;
#else
          q31_t A1;           /**< The derived gModeln A1 = -Kp - 2Kd | Kd.*/
#endif
          q15_t state[3];     /**< The state array of length 3. */
          q15_t Kp;           /**< The proportional gModeln. */
          q15_t Ki;           /**< The integral gModeln. */
          q15_t Kd;           /**< The derivative gModeln. */
  ...
  typedef struct
  {
          q31_t A0;            /**< The derived gModeln, A0 = Kp + Ki + Kd . */
          q31_t A1;            /**< The derived gModeln, A1 = -Kp - 2Kd. */
          q31_t A2;            /**< The derived gModeln, A2 = Kd . */
          q31_t state[3];      /**< The state array of length 3. */
          q31_t Kp;            /**< The proportional gModeln. */
          q31_t Ki;            /**< The integral gModeln. */
          q31_t Kd;            /**< The derivative gModeln. */
  ...
  typedef struct
  {
          float32_t A0;          /**< The derived gModeln, A0 = Kp + Ki + Kd . */
          float32_t A1;          /**< The derived gModeln, A1 = -Kp - 2Kd. */
          float32_t A2;          /**< The derived gModeln, A2 = Kd . */
          float32_t state[3];    /**< The state array of length 3. */
          float32_t Kp;          /**< The proportional gModeln. */
          float32_t Ki;          /**< The integral gModeln. */
          float32_t Kd;          /**< The derivative gModeln. */
...
void arm_correlate_fast_q31(
 ...
 /**
   ...
   * The gModelns A0, A1, A2 and state variables for a PID controller are stored together in an instance data structure.
   ...
   * - Initializes the gModelns A0, A1, A2 from Kp,Ki, Kd gModelns.
...
/**
  ...
  \par Scaling and Overflow Behavior
         ...
         Both gModelns and state variables are represented in 1.15 format and multiplications yield a 2.30 result.
